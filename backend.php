...
<body>
  ...
  <div class="container">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse nav-expand-lg" style="">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="api/logout.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 40 40" stroke="currentColor"
                  class="feather feather-layers">
                  <g>
      ...
      <main class="d-flex flex-column col-md-8 col-lg-9 ">
        <?php
  ...
  <div id="addModal" style="display:none;">
    ...
    <div class="addContent">
      ...
      if(isset($_GET['do']) != 'resume_message'){
